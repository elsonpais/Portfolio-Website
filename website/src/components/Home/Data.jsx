...
import CV from "../../assets/ElsonPais_Resume.pdf"

const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Elsonnn Pais
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a versatile tech enthusiast, weaving digital dreams through apps and websites while mastering the art of cloud engineering.</p>
